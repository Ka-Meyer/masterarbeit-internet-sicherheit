    ...
    try {
      switch (command) {
        ...
        case 'pw':
          ...
          await page.click('xpath=//button[@id="cal-login-button"]');

          //select MFA Method as Push in App
          const mfaSelector = 'xpath=//button[@id="smartphone_push_button"]';
          await page.waitForSelector(mfaSelector);
          await page.click(mfaSelector);

          console.log(`mf in salesforce app`);

          await new Promise(resolve => setTimeout(resolve, 10000));
          //Cookie auslesen
          //Cookies haben nicht funktioniert. Falsche Domain ausgelesen?
